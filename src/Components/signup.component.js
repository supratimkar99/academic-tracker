                ...
                <div className="form-wrapper">
                    ...
                    <br />
                        <form onSubmit={this.handleSubmit} class="signup-form">
                            <div className="Name">
                                <input className={formErrors.Name.length > 0 ? "error" : "norm"} class="signup-input" 
                            ...
                            <div className="email">
                                <input 
                                    className={formErrors.email.length>0?"error":"norm"} class="signup-input"
                                    placeholder="Email" 
                                    type="email" 
                                    name="email"    
                                    noValidate
                            ...
                            <div className="password" >
                                <input    
                                    className={formErrors.password.length>0?"error":"norm"} class="signup-input"
